    ...
    <div class="receipt">
        ...
        <div class="details">
            ...
            <div class="row">
                ...
                <div class="value">{{ $receipt->payment_date->format('d/m/Y') }}</div>
            </div>
            <div class="row">
        ...
        <div class="payment-info">
            ...
            <div class="row">
                ...
                <div class="value">KES {{ number_format($receipt->feePayment->studentFee->total_payable, 2) }}</div>
            </div>
            <div class="row">
        ...
        <div class="no-print" style="text-align: center; margin-top: 20px;">
            ...
            <button onclick="window.close()" class="button">Close</button>
        </div>
    </div>
</body>
</html>
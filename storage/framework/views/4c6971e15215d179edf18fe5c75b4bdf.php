    ...
    <body>
        <div class="header-nav">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(url('/admin')); ?>" class="btn btn-outline">Dashboard</a>
            <?php else: ?>
                <a href="<?php echo e(url('/admin/login')); ?>" class="btn btn-outline">Staff/Student Login</a>
        ...
        <div class="main-content">
            <div class="info-panel">
                ...
                <div>
                    <a href="<?php echo e(url('/admin/login')); ?>" class="btn-primary">
                        Login to Dashboard
                    </a>
                </div>
                
                <p class="footer-text">
                    v<?php echo e(app()->version()); ?> | School Management System
                </p>
            </div>
...
</html><?php /**PATH C:\Users\Maina\Herd\smv2\resources\views/welcome.blade.php ENDPATH**/ ?>